...
namespace planning
{
	...
	Time::Time(int h, int m)
	{
		...
		if (h < 0 || h > 23) throw TimeException("Heure nom comprise entre 0 et 23.", TimeException::OVERFLOW);
		if (m < 0 || m > 59) throw TimeException("Minute nom comprise entre 0 et 59.", TimeException::OVERFLOW);
	...
	Time::Time(int duree)
	{
		...
		if (duree < 0 || (duree / 60) > 23) throw TimeException("Duree nom comprise entre 0h00 et 23h59.", TimeException::OVERFLOW);
